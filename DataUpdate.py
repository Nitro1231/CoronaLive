...
html = html.replace('total_confirmed', total_confirmed).replace('total_deaths', total_deaths).replace('total_recovered', total_recovered).replace('total_active', total_active).replace('mortality_rate', mortality_rate).replace('recovery_rate', recovery_rate)
